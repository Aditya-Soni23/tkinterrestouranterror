...
label_select_addons.place(relx =0.8, rely = 0.5, anchor=CENTER )
...
label_dish_amount = Label(root,font = ("times",15,"bold"))
label_dish_amount.place(relx = 0.2, rely = 0.72 ,anchor=CENTER)
    ...
    def __init__(self):
        ...
        def menu(dish):
            if dish=="burger":
                ...
                toppings_dropdown["values"]=toppings
                print("Add chocolate flavour | Add caramel")
            else:
...
btn_amount = Button(root,text = "Amount",command = child2_object.get_final_amount,bg = "Blue",fg="white",releif = FLAT)
